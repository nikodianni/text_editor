...
Díky modernímu balíčkování přes `pyproject.toml` je instalace a spuštění velmi snadné.

1. Naklonuj si tento repozitář nebo stáhni zdrojové kódy.
2. Otevři terminál ve složce s projektem (tam, kde je soubor `pyproject.toml`).
